...
### RULE-ENG-002 — Next.js 16 Breaking Conventions
**Statement:** This project uses Next.js 16.3.5 and React 19. APIs, conventions, and file structures may differ from older versions. Read relevant guides in node_modules/next/dist/docs/ before writing new route or server code.
**Canonical home:** `ENGINEERING.md`
**Mirrors:** NOTES.md
**Enforced by:** Type check (`npm run build`) and lint (`npm run lint`)
**Status:** active
**Origin:** owner (migrated from legacy AGENTS.md, 2026-09-22)

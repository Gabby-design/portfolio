      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          <LiquidGlassWrapper
            ...
            className="p-6 sm:p-8 rounded-2xl border border-white/18 flex flex-col gap-4 shadow-xl bg-[#010101]/60"
          >
              ...
              {socialLinks.map((item) => {
                ...
                return (
                  <LiquidGlassWrapper
                    ...
                    className={`p-3 rounded-full border border-white/12 hover:border-[#00E676]/50 flex items-center justify-center gap-2 text-xs font-semibold text-slate-300 transition-colors cursor-pointer group bg-white/5 ${item.color}`}
                  >
                    <Icon className="w-4 h-4 text-slate-400 group-hover:scale-110 group-hover:text-[#00E676] transition-all" />
            ...
            {/* Availability Note */}
            <div className="mt-4 p-4 rounded-xl bg-[#010101]/80 border border-white/12 flex items-center gap-3">
        ...
        <div className="lg:col-span-7">
          <LiquidGlassWrapper
            ...
            fallbackClassName="liquid-glass-fallback"
            className="p-6 sm:p-10 rounded-2xl border border-white/18 shadow-2xl relative bg-[#010101]/60"
          >
            {status === 'success' ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-[#010101]/80 border border-white/12 text-sm text-white placeholder-[#4B5563] focus:outline-none focus:border-[#00E676]/60 focus:ring-1 focus:ring-[#00E676]/40 transition-all"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-[#010101]/80 border border-white/12 text-sm text-white placeholder-[#4B5563] focus:outline-none focus:border-[#00E676]/60 focus:ring-1 focus:ring-[#00E676]/40 transition-all resize-none"
                  />
                </div>
                ...
                <LiquidGlassWrapper
                  ...
                  liquidPress={{ scale: 0.94, squish: 0.03 }}
                  fallbackClassName="liquid-glass-pill-fallback"
                  className="w-full mt-2 py-3.5 px-6 rounded-full text-sm font-semibold text-white bg-[#00E676]/20 hover:bg-[#00E676]/30 border border-[#00E676]/60 shadow-[0_0_28px_rgba(0,230,118,0.25)] flex items-center justify-center gap-2 transition-all cursor-pointer disabled:opacity-50"
                >
                  {status === 'submitting' ? (
